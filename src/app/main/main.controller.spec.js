(function() {
  ...
  describe('controllers', function(){
    ...
    beforeEach(module('shersialBtGulp'));
    ...
    it('should define animate class after delaying timeout ', function() {
      $timeout.flush();
      expect(vm.classAnimation).toEqual('swing');
    });
    ...
    it('should define more than 5 awesome things', function() {
      expect(angular.isArray(vm.behanceProjects)).toBeTruthy();
      expect(vm.behanceProjects.length === 5).toBeTruthy();
    });
  });
})();
